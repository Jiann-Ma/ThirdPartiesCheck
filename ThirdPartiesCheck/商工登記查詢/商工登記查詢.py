...
def main(input_path, File_Path):
    ...
    # 點擊「分公司」
    time.sleep(2)
    driver.find_element(By.XPATH, '(//input[@name="qryType"])[2]').click()
    ...
    for row in df_input.index:
        ...
        try:
            ...
            driver.find_element(By.XPATH, '//*[@id="qryCond"]').clear()
            continue
        time.sleep(2)
        ...
        try:
           ...
           driver.save_screenshot(File_Path + '\\' + f'{forVerifyNo}.png')
           print("[INFO] 無查詢結果，拍照留存！") 
           driver.find_element(By.XPATH, '//*[@id="bs-example-navbar-collapse-1"]/ul/li[3]').click()
           time.sleep(2)
           driver.find_element(By.XPATH, '//*[@id="qryCond"]').clear()
           continue
        time.sleep(2)
